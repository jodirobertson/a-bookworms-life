...
//                    " 15.0 from t=3 to t=5\n" +
//                    "Shape Handle scales from Width: 10.0, Height: 8.0 to Width: 5.0, Height: 4.0" +
//                    " from t=3 to t=5\n" +
//                    "Shape ToolBox changes color from (1.0,0.5,1.0) to (0.5,0.5,1.0) from t=3 " +
//                    "to t=5\n" +
//                    "Shape Handle moves from (500.0,120.0) to (500.0,127.0) from t=4 to t=8",
//            model.getState());
//  }
//
...
//                    " 100.0 from t=3 to t=80\n" +
//                    "Shape R moves from (200.0,200.0) to (300.0,300.0) from t=10 to t=50\n" +
//                    "Shape C changes color from (0.0,0.0,1.0) to (0.0,1.0,0.0) from t=12 to " +
//                    "t=40\n" +
...
//                    "Shape C moves from (500.0,400.0) to (500.0,700.0) from t=71 to t=80",
//            model.getState());
//  }
//
...
//            "from t=0 to t=10\n" +
//            "Shape C scales from X radius: 60.0, Y radius: 30.0 to X radius: 30.0, Y radius:" +
//            " 30.0 from t=0 to t=10\n" +
//            "Shape R scales from Width: 25.0, Height: 100.0 to Width: 75.0, Height: 400.0 from " +
//            "t=11 to t=20\n" +
//            "Shape C scales from X radius: 30.0, Y radius: 30.0 to X radius: 45.0, Y radius: " +
//            "15.0 from t=20 to t=50", model.getState());
//  }
//
...
//                    "Disappears at t=100\n" +
//                    "\n" +
//                    "Shape R changes color from (1.0,0.0,0.0) to (1.0,1.0,1.0) from t=0 to t=10\n" +
//                    "Shape C changes color from (0.0,0.0,1.0) to (1.0,1.0,1.0) from t=0 to t=10\n" +
//                    "Shape R changes color from (1.0,1.0,1.0) to (0.0,0.0,0.0) " +
//                    "from t=20 to t=30\n" +
//                    "Shape C changes color from (1.0,1.0,1.0) to (0.0,0.0,0.0) from t=23 to t=40",
//            model.getState());
//
//  }
//
...
//            "Disappears at t=100\n" +
//            "\n" +
//            "Shape R moves from (0.0,0.0) to (100.0,100.0) from t=10 to t=50\n" +
//            "Shape C moves from (500.0,100.0) to (600.0,200.0) " +
//            "from t=10 to t=50", model.getState());
//
//  }
//
...
//    IModel model = new IModelImpl();
//    assertEquals("Shapes:", model.getState());
//    IFigure r = new IFigureImplDummy(model, "rectangle", new double[]{1, 0, 0}, "R", 0,
//            0, 1, 100, 50, 100);
//    model.add(r);
//    assertEquals("Shapes:\n" +
...
//  }
//
//  // tests an empty canvas for getState()
//  @Test
...
//            " from t=70 to t=100", model.getState());
//  }
//}
//
//
